...
export function MenuInner() {
  ...
  return (
    <>
      ...
      <MenuItem title={intl.formatMessage({id: 'MENU.Pages'})} to='/Pages' />
      <MenuItem title={intl.formatMessage({id: 'MENU.Apps'})} to='/apps' />
      <MenuItem title={intl.formatMessage({id: 'MENU.Layouts'})} to='/layout' />
      <MenuItem title={intl.formatMessage({id: 'MENU.Help'})} to='/help' />
